...
- 每日收益：在财务页轻量记录抖音等平台每天的创作者收益，并按同一时间范围汇总
- 品类分析：按上衣、裤子、套装、裙子、鞋子、配饰、其他、未分类统计金额和合作数
- 我的：修改密码、已完成合作、垃圾桶、导出 Excel 可打开的表格
- 导入 Excel：从旧 `.xlsx` 表格自动识别品牌、产品、品类、发布日期、金额、状态和备注，预览确认后批量写入
...
- 每日创作者收益保存在独立的 `daily_earnings` 表，不和商单佣金混算；同一天重复填写会更新当天记录。
